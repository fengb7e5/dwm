...
static const char *roficmd[] =       {"./.dwm/launcher.sh",          NULL};
...
static Key keys[] = {
  ...
  {MODKEY | ShiftMask,            XK_space,                 spawn,          {.v = toggleTouchpad}},
  {MODKEY,                        XK_a,                     spawn,          {.v = flameshot}},
  {MODKEY,                        XK_z,                     spawn,           SHCMD("feh --bg-fill  --randomize ~/Pictures/*")},
  {MODKEY,                        XK_F6,                     spawn,          SHCMD("amixer sset Master toggle")},
  {MODKEY,                        XK_F7,                     spawn,          SHCMD("amixer sset Master 5%+ umute")},
  {MODKEY,                        XK_F8,                     spawn,          SHCMD("amixer sset Master 5%- umute")},
  {MODKEY,                        XK_F9,                     spawn,          SHCMD("light -A 10")},
  {MODKEY,                        XK_F10,                     spawn,         SHCMD("light -U 10")},
  // rofi
  {MODKEY,                        XK_p,                     spawn,          {.v = roficmd}},
  {MODKEY | ControlMask,          XK_p,                     spawn,          {.v = modulecmd}},
  {MODKEY | ShiftMask,            XK_m,                     spawn,          {.v = mpdcmd}},
  {MODKEY | ControlMask,          XK_m,                     spawn,          {.v = powercmd}},
  {MODKEY | ShiftMask,            XK_p,                     spawn,          {.v = linkcmd}},
